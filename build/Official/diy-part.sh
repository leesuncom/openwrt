...
# sed -i '10s/"OpenClash"/"世界之窗"/g' `egrep "OpenClash" -rl /usr/lib/lua/luci/controller/openclash.lua`
sed -i '6s/"OpenClash"/"世界之窗"/g' `egrep "OpenClash" -rl feeds/OpenClash/luci-app-openclash/luci-app-openclash/po/zh-cn/openclash.zh-cn.po
